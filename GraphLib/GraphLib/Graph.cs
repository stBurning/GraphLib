...
namespace GraphLib {
    public class Graph {
        ...
        public List<Vertex> GetLowestWay(int start, int finish)
        {
            ...
            if (Vertices[finish].ShortWay.Count != 0){
                Vertices[finish].ShortWay.Add(Vertices[finish]);
            }
            return Vertices[finish].ShortWay;
        }
